...
from mezo_trainer.trainer import MezoTrainer
from mezo_trainer.seq2seq_args_mezo import TrainingArguments_Mezo
...
training_args = TrainingArguments_Mezo(
    output_dir="../whisper-small-DI-MeZO", 
