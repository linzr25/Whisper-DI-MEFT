...
config = LoraConfig(r=64, lora_alpha=512, target_modules=["q_proj", "v_proj"], lora_dropout=0, bias="none")
...
training_args = TrainingArguments(
    output_dir="/gs/bs/tga-nakadailab/linzirui/work1/whisper-base-dialect-identificaion-LoRA-64-loss", # change to a repo name of your choice
