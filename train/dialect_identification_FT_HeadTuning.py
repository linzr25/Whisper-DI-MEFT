...
dataset = DatasetDict()
dataset["train"] = load_from_disk("/gs/bs/tga-nakadailab/linzirui/work1/Datasets/KeSpeech_Dialects/prepared_full/train")
dataset["test"] = load_from_disk("/gs/bs/tga-nakadailab/linzirui/work1/Datasets/KeSpeech_Dialects/prepared_full/test")
...
training_args = TrainingArguments(
    output_dir="../whisper-small-DI-HeadTuning", 
